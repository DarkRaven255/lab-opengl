...
void sciana(float x, float y) {

	//wiercho³ki sciany
	GLfloat sa[3] = { -50.0f, 0.0f, 0.0f };
	GLfloat sb[3] = { 50.0f,0.0f, 0.0f };
	GLfloat sc[3] = { 50.0f, 40.0f,0.0f };
	GLfloat sd[3] = { -50.0f, 40.0f,0.0f };
	GLfloat se[3] = { -50.0f, 0.0f, -20.0f };
	GLfloat sf[3] = { 50.0f,0.0f, -20.0f };
	GLfloat sg[3] = { 50.0f,40.0f, -20.0f };
	GLfloat sh[3] = { -50.0f, 40.0f, -20.0f };

	//wierzcho³ki okna
	if (x > 30.0f || x < -30.0f) x = 0.0f;
	if (y > 20.0f || y < 0.0f) y = 10.0f;

	//wierzcho³ki okna
	GLfloat wa[3] = { x - 10.0f, y, 0.0f };
	GLfloat wb[3] = { x + 10.0f, y, 0.0f };
	GLfloat wc[3] = { x + 10.0f, y + 20.0f, 0.0f };
	GLfloat wd[3] = { x - 10.0f, y + 20.0f, 0.0f };
	GLfloat we[3] = { x - 10.0f, y, -20.0f };
	GLfloat wf[3] = { x + 10.0f, y, -20.0f };
	GLfloat wg[3] = { x + 10.0f, y + 20.0f, -20.0f };
	GLfloat wh[3] = { x - 10.0f, y + 20.0f, -20.0f };

	//wiercho³ki obok okna
	GLfloat wi[3] = { x - 10.0f, 0.0f, 0.0f };
	GLfloat wj[3] = { x + 10.0f, 0.0f, 0.0f };
	GLfloat wk[3] = { x + 10.0f, 40.0f, 0.0f };
	GLfloat wl[3] = { x - 10.0f, 40.0f, 0.0f };
	GLfloat wm[3] = { x - 10.0f, 0.0f, -20.0f };
	GLfloat wn[3] = { x + 10.0f, 0.0f, -20.0f };
	GLfloat wo[3] = { x + 10.0f, 40.0f, -20.0f };
	GLfloat wp[3] = { x - 10.0f, 40.0f, -20.0f };
...
void mur() {
	...
	GLfloat sd[3] = { -50.0f, 40.0f, 0.0f };
	//drzwi
	GLfloat se[3] = { -15.0f, 0.0f, 1.0f };
	GLfloat sf[3] = { -30.0f, 0.0f, 1.0f };
	GLfloat sg[3] = { -30.0f, 25.0f, 1.0f };
	GLfloat sh[3] = { -15.0f, 25.0f, 1.0f };
	//okno
	GLfloat da[3] = { 10.0f, 15.0f, 1.0f };
	GLfloat db[3] = { 30.0f, 15.0f, 1.0f };
	GLfloat dc[3] = { 30.0f, 30.0f, 1.0f };
	GLfloat dd[3] = { 10.0f, 30.0f, 1.0f };
	//dach
	GLfloat pa[3] = { -30.0f, 60.0f, 1.0f };
	GLfloat pb[3] = { 30.0f, 60.0f, 1.0f };
	GLfloat pc[3] = { 55.0f, 40.0f, 1.0f };
	GLfloat pd[3] = { -55.0f, 40.0f, 1.0f };
	//komin
	GLfloat ca[3] = { -5.0f, 60.0f, 1.0f };
	GLfloat cb[3] = { 5.0f, 60.0f, 1.0f };
	GLfloat cc[3] = { 5.0f, 70.0f, 1.0f };
	GLfloat cd[3] = { -5.0f, 70.0f, 1.0f };

	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);

	//sciana
	//glColor3f(0.6f, 0.8f, 0.1f);
	glColor3ub(255.0f, 191.0f, 23.0f);
	glBegin(GL_POLYGON);
	glVertex3fv(sa);
	glVertex3fv(sb);
	glVertex3fv(sc);
